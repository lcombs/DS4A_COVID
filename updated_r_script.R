...
dc_group_pvar <- pvargmm(dependent_vars = c("workplaces", 
...
stab_dc_group_pvar <- stability(dc_group_pvar)
...
dc_group_pvar_girf <- girf(dc_group_pvar, n.ahead = 8, ma_approx_steps= 8)
